...
public class ContactService {
	...
	void inputAddNewContact()throws Exception									//Method To Input Contact Details
	...
	public ArrayList<String> contactNumberInput()throws Exception				//Method To Input Contact Numbers in Number List
	{
	...
	public boolean isEmailValid(String email)									//Utility Method to validate Email 
    { 
	...
	public boolean isContactNumValid(String num)								//Utility Method to validate ContactNumber
	{
		return (num.length()<=10 && num.length()>=7);
	}
	
	public boolean isContactIDValid(int id)throws Exception						//Utility Method to check Existing Cntacts
	{
		PreparedStatement ps=con.prepareStatement("select cid from Contacts");
	...
	public void addNewContact(Contact contact)throws Exception					//Adds Valid Contact in ArrayList
	{
		contactsIP.add(contact);
	}
	
	public void insertContactInDB()												//Inserts List of Contacts in DB
	{
		try
		{
	...
	public String buildContactNum(Iterator<Contact> it)							//Builds a String of contact numbers seperated by ,
	{
		String nums="";
	...
	public String buildContactNum(ArrayList<String> al)							//Utility : Builds Number String from ArrayList
	{
		String nums="";
	...
	public void inputSearchContactByName()throws Exception						//Inputs Contact Name to be Searched 
	{
		System.out.println("Enter Contact Name");
	...
	public Contact searchContactByName(String name)								//Searches Contact in List
	{	
		try
		{
			Iterator<Contact> it=contactsIP.iterator();
	...
	public ArrayList<String> buildNumArrayList(String str)						//Utility : String numbers to ArrayList for Contact
	{
	...
	public ArrayList<Contact> searchContactByNumber(String ip)					//Searches Contact by Contact Number
	{
	...
	public boolean isContactPresent(String src,String ip)						//Utility : Checks for input Contact exists in DB Contact String
	{
	...
	{
		File f=new File("E:/eclipse/workspace/Contacts.txt");
		//if(f.exists())
